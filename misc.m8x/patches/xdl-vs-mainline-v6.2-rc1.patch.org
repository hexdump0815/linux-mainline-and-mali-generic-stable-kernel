...
index 79bfe3938d3c..03333ba38d64 100644
...
index d4b907889a21..836dac22c8e1 100644
...
index 6e5ea0213b47..855da134f8ca 100644
...
+static int meson_mmc_clk_init(struct meson_host *host, void __iomem *regs)
 {
 	...
 	struct clk_mux *mux;
@@ -436,7 +427,7 @@ static int meson_mmc_clk_init(struct meson_host *host)
...
@@ -464,7 +455,7 @@ static int meson_mmc_clk_init(struct meson_host *host)
...
+	mux->reg = regs + SD_EMMC_CLOCK;
 	...
 	mux->hw.init = &init;
@@ -486,7 +477,7 @@ static int meson_mmc_clk_init(struct meson_host *host)
...
+	div->reg = regs + SD_EMMC_CLOCK;
 	...
 	div->hw.init = &init;
@@ -507,21 +498,15 @@ static int meson_mmc_clk_init(struct meson_host *host)
...
@@ -534,19 +519,21 @@ static int meson_mmc_resampling_tuning(struct mmc_host *mmc, u32 opcode)
...
+					      (dly + i) % max_dly));
 		...
 		if (!ret) {
@@ -651,10 +638,8 @@ static void meson_mmc_set_ios(struct mmc_host *mmc, struct mmc_ios *ios)
...
@@ -680,7 +665,7 @@ static void meson_mmc_set_blksz(struct mmc_host *mmc, unsigned int blksz)
...
@@ -695,9 +680,8 @@ static void meson_mmc_set_blksz(struct mmc_host *mmc, unsigned int blksz)
...
@@ -723,7 +707,6 @@ static void meson_mmc_desc_chain_transfer(struct mmc_host *mmc, u32 cmd_cfg)
...
@@ -751,8 +734,8 @@ static void meson_mmc_desc_chain_transfer(struct mmc_host *mmc, u32 cmd_cfg)
...
@@ -773,28 +756,19 @@ static void meson_mmc_copy_buffer(struct meson_host *host, struct mmc_data *data
...
@@ -861,11 +835,11 @@ static void meson_mmc_start_cmd(struct mmc_host *mmc, struct mmc_command *cmd)
...
@@ -915,7 +889,7 @@ static void meson_mmc_request(struct mmc_host *mmc, struct mmc_request *mrq)
...
@@ -925,12 +899,12 @@ static void meson_mmc_read_resp(struct mmc_host *mmc, struct mmc_command *cmd)
 	struct meson_host *host = mmc_priv(mmc);
...
@@ -941,7 +915,7 @@ static void __meson_mmc_enable_sdio_irq(struct mmc_host *mmc, int enable)
...
+	regmap_read(host->regmap, SD_EMMC_STATUS, &raw_status);
 	...
 	if (!status) {
@@ -965,7 +939,7 @@ static irqreturn_t meson_mmc_irq(int irq, void *dev_id)
 		return IRQ_NONE;
...
@@ -1038,9 +1009,9 @@ static int meson_mmc_wait_desc_stop(struct meson_host *host)
...
@@ -1106,7 +1077,7 @@ static void meson_mmc_cfg_init(struct meson_host *host)
...
@@ -1114,7 +1085,7 @@ static int meson_mmc_card_busy(struct mmc_host *mmc)
 	struct meson_host *host = mmc_priv(mmc);
 	u32 regval;
...
@@ -1172,11 +1143,19 @@ static const struct mmc_host_ops meson_mmc_ops = {
...
@@ -1218,9 +1197,9 @@ static int meson_mmc_probe(struct platform_device *pdev)
 	}
...
@@ -1250,11 +1229,16 @@ static int meson_mmc_probe(struct platform_device *pdev)
 		goto free_host;
 	}
...
@@ -1262,12 +1246,12 @@ static int meson_mmc_probe(struct platform_device *pdev)
...
@@ -1311,7 +1295,6 @@ static int meson_mmc_probe(struct platform_device *pdev)
...
-		host->bounce_iomem_buf = host->regs + SD_EMMC_SRAM_DATA_BUF_OFF;
 		...
 		/* data bounce buffer */
@@ -1359,7 +1342,7 @@ static int meson_mmc_remove(struct platform_device *pdev)
...
@@ -132,6 +132,7 @@ struct meson_nand_ecc {
...
@@ -154,7 +155,6 @@ struct nand_timing {
 struct meson_nfc {
...
@@ -213,7 +213,7 @@ static int meson_nand_calc_ecc_bytes(int step_size, int strength)
 	return ecc_bytes;
 }
...
@@ -1002,47 +1002,41 @@ static int meson_nfc_clk_init(struct meson_nfc *nfc)
...
@@ -1058,8 +1052,6 @@ static int meson_nfc_clk_init(struct meson_nfc *nfc)
 err_disable_clk:
...
@@ -1067,7 +1059,6 @@ static int meson_nfc_clk_init(struct meson_nfc *nfc)
...
@@ -1348,16 +1339,32 @@ static irqreturn_t meson_nfc_irq(int irq, void *id)
 	return IRQ_HANDLED;
 }
...
@@ -1388,13 +1395,15 @@ static int meson_nfc_probe(struct platform_device *pdev)
...
@@ -335,6 +346,79 @@ static int rtl8211c_config_init(struct phy_device *phydev)
...
@@ -416,6 +500,18 @@ static int rtl8211f_config_init(struct phy_device *phydev)
 		}
 	}
...
index e20874caba36..a7e9fc799d8a 100644
...
@@ -44,6 +45,23 @@ struct usb_conn_info {
...
@@ -87,7 +105,12 @@ static void usb_conn_detect_cable(struct work_struct *work)
...
@@ -111,12 +134,9 @@ static void usb_conn_detect_cable(struct work_struct *work)
...
@@ -223,34 +243,34 @@ static int usb_conn_probe(struct platform_device *pdev)
 	if (info->id_gpiod) {
...
@@ -298,6 +318,8 @@ static int __maybe_unused usb_conn_suspend(struct device *dev)
 	if (info->vbus_gpiod)
...
index c9f06c5e4e9d..52e7211ed1fc 100644
